...
def is_blackjack(card_one, card_two):
    ...
    """
    # Both cards must not be Ace
    if card_one == "A" and card_two == "A" :
        return False
    # one out of the two cards must be an Ace and the other must be a face card
    if ((card_one ==  "J" or "K"or "Q") and  (card_two == "A")) or ((card_two ==  "J" or "K" or "Q") and  (card_one == "A")):
        return True
    # 
    return False
...
def can_split_pairs(card_one, card_two):
   ...
   Returns:
    ...
    # below is the solution using the value_card function
    if value_of_card(card_one) == value_of_card(card_two) :
        return True
    # when the cards are not equal
    return False
...
def can_double_down(card_one, card_two):
    ...
    if (card_one != card_two) and ( 9 <= (value_of_card(card_one) + value_of_card(card_two)) <= 11 ) :
        return True
    return False
